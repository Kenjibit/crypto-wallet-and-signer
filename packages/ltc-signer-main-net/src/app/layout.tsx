...
export const metadata: Metadata = {
  title: 'LTC Transaction Signer',
  description: 'Offline Litecoin transaction signer for air-gapped security',
  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <meta name="apple-mobile-web-app-title" content="LTC Signer" />
        <meta name="mobile-web-app-capable" content="yes" />

        {/* Critical PWA Meta Tags - Prevent Browser Opening */}
        <meta name="application-name" content="LTC Signer" />
        <meta name="msapplication-TileColor" content="#345d9d" />
