...
export const metadata: Metadata = {
  ...
  description: 'Create and broadcast Bitcoin transactions with PSBT support',
  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <meta name="apple-mobile-web-app-title" content="BTC Creator" />
        <meta name="mobile-web-app-capable" content="yes" />

        {/* Critical PWA Meta Tags - Prevent Browser Opening */}
        <meta name="application-name" content="BTC Creator" />
