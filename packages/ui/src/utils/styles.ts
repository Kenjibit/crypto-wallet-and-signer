 ...
 * @returns Combined class string
 */
export const createVariantClass = (base: string, variant: string) => {
 ...
 * @returns Combined class string
 */
export const createSizeClass = (base: string, size: string) => {
 ...
 * @returns Combined class string
 */
export const createStateClass = (base: string, state: string) => {
